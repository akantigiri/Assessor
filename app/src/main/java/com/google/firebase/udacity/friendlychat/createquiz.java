    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        f2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(createquiz.this, String.valueOf(previousQuestion), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cont)
                {
                    previousQuestion++;
                    currentQuestion++;
                    Toast.makeText(createquiz.this, "QUESTION " + currentQuestion, Toast.LENGTH_SHORT).show();
                    questionNumber.setText(String.valueOf(currentQuestion));
                    clearAllData();
                    f2.setVisibility(View.VISIBLE);
                }
...
//                                         result.setText(userInput.getText());
                                                ...
                                                if (!TextUtils.isEmpty(fileName))
                                                    myRef.child(SecondActivity.hy).child("quizzes").child(fileName).setValue(result);
                                                finish();
                                            }
                                        }
                                    })
                ...
                {
                    Toast.makeText(createquiz.this, "Incomplete question format", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(createquiz.this);
